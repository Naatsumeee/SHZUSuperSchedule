...
& "$base\gradle\gradle-9.7.1\bin\gradle.bat" assembleRelease --no-daemon --console=plain 2>&1 | Tee-Object -FilePath "C:\Users\xutia\WorkBuddy\SHZUClassList\km_build_v132.txt"
